...
sudo docker-compose -f bin/docker/docker-compose.yml run assessment_a7_reactjs /bin/sh -c "chmod +x bin/*.sh;chmod +x bin/docker/*.sh"

echo "== Starting services"
sudo docker-compose -f bin/docker/docker-compose.yml up -d

echo "== Generating docs"
sudo docker-compose -f bin/docker/docker-compose.yml exec assessment_a7_reactjs /bin/sh -c "jsdoc ./src -c ./bin/config/docs/config.json --readme README.md -t /node_modules/docdash"
